...
const Categories = () => {
  ...
  const [isCompact, setIsCompact] = useState(true); // Header için kompakt görünüm
  ...
  // Header için kompakt kategori kartı
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        <div className="text-left">
          ...
          <p className="text-sm text-gray-500">{category.count} kitap</p>
        </div>
      </div>
  ...
  // Kompakt görünüm için kategori grid'i
  const CompactCategoryGrid = () => (
  ...
  // Tam görünüm için kategori grid'i
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            >
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
                  d={isCompact ? "M4 6h16M4 12h16M4 18h16" : "M4 6h16M4 10h16M4 14h16M4 18h16"} />
              </svg>
              {isCompact ? 'Geniş Görünüm' : 'Kompakt Görünüm'}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        {isCompact ? <CompactCategoryGrid /> : <FullCategoryGrid />}
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              {filteredBooks.length > 0 ? (
                ...
                <p className="text-center text-gray-500 py-8">Bu kategoride henüz kitap bulunmuyor.</p>
              )}
            </div>
          </div>
        )}
